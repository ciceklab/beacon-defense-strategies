...
CUDA_VISIBLE_DEVICES=1 nohup python main.py --train beacon --attacker_type optimal --beacon_type agent --gene_size 1000000 --max_queries 100 --results-dir ./results/train > ./logs/beacon2_log01.txt &
